(defproject om-example "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "om-example.core/on-js-reload"
                ...
                :compiler {:main om-example.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/om_example.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/om_example.js"
                           :main om-example.core
